...
Let $R = r_1 + r_2 + \ldots + r_k$, represent the total number of radios. Where $R$ ranges from $k$ to $M$ since we must have at least 1 of each radio type (and there are $k$ amount of types).
